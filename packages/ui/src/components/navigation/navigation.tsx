...
function NavigationTrigger({
  ...
  return (
    <Primitive.Trigger
      ...
      className={cn(navigationTriggerStyle(), "group", className)}
      {...props}
    >
      {children}{" "}
      <ChevronDownIcon
